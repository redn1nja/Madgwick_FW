...
void read_gyro_data(IMUData* data){
    ...
    data->gyroX = buffer[0] * DIVISOR * DEGREE_TO_RADIAN;
    data->gyroY = buffer[1] * DIVISOR * DEGREE_TO_RADIAN;
    data->gyroZ = buffer[2] * DIVISOR * DEGREE_TO_RADIAN;
}
